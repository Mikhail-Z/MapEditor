import geojson2shapefile as shape
import json
...
class GeoJ:
    ...
    def __createPoint(self):
        ...
        self.shpFileObj = shape.Writer(shape.POINT)
    ...
    def __createLine(self):
        ...
        self.shpFileObj = shape.Writer(shape.POLYLINE)
        self.shpFileObj.autoBalance = 1
        self.__createColumns()
    ...
    def __createPolygon(self):
        ...
        self.shpFileObj = shape.Writer(shape.POLYGON)
        self.shpFileObj.autoBalance = 1
        self.__createColumns()
